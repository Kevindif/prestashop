...
class appProdProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => '', 'dbname' => 'eproject', 'user' => 'root', 'password' => '', 'charset' => 'UTF8', 'driverOptions' => array(1002 => 'SET sql_mode=(SELECT REPLACE(@@sql_mode,\'ONLY_FULL_GROUP_BY\',\'\'))'), 'serverVersion' => 5.0999999999999996), new \Doctrine\DBAL\Configuration(), $a, array('enum' => 'string'));
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('D2xyjiwyfFbxOvvvhBH8LR2u0zUtaUEU3BcoUJZgm6JNFuCDcXb9f4Qz');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5a945a030be277.01382352')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'secret' => 'D2xyjiwyfFbxOvvvhBH8LR2u0zUtaUEU3BcoUJZgm6JNFuCDcXb9f4Qz',
            'ps_caching' => 'CacheMemcache',
            'ps_cache_enable' => false,
            'ps_creation_date' => '2018-02-26',
            'locale' => 'fr-FR',
            'cookie_key' => 'ODhiXwTW2Ai5oqQgqn5enETpiwZVaao8qEtyM44a5H1eQGKawdoPYraS',
            'cookie_iv' => 'ms7AOhuz',
            'new_cookie_key' => 'def00000c475be264209cdeea65058145869711e42114afce9f96de1934c6aadd7f398256b661804bfb7d8f143992d763a800b258f653823e5fdade087c1d9a01381e5c1',
            ...
            'kernel.secret' => 'D2xyjiwyfFbxOvvvhBH8LR2u0zUtaUEU3BcoUJZgm6JNFuCDcXb9f4Qz',
